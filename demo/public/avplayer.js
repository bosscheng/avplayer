...
`;
    ...
    class MediaCenterWorker extends eventemitter3 {
      _worker = undefined;
      _player;
    ...
    class VideoDecoderSoftBase extends eventemitter3 {
      decoderState;
      decoder;
      config;
      module;
    ...
    var Module$2 = (() => {
      var _scriptDir = (typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('avplayer.js', document.baseURI).href));
      return function (Module) {
        ...
        if (Module["locateFile"]) {
          ...
          wasmBinaryFile = new URL("videodec.wasm", (typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('avplayer.js', document.baseURI).href))).toString();
        }
        ...
        Module["_ff_h264_cabac_tables"] = 145029;
    ...
    class VideoDecoderSoft extends VideoDecoderSoftBase {
      constructor() {
        super(Module$2);
      }
    ...
    var Module$1 = (() => {
      ...
      return function (Module) {
        ...
        if (Module["locateFile"]) {
          ...
          wasmBinaryFile = new URL("videodec_simd.wasm", (typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('avplayer.js', document.baseURI).href))).toString();
        }
        ...
        Module["___embind_register_native_and_builtin_types"] = function () {
          return (Module["___embind_register_native_and_builtin_types"] = Module["asm"]["B"]).apply(null, arguments);
        };

        var ___cxa_is_pointer_type = Module["___cxa_is_pointer_type"] = function () {
          return (___cxa_is_pointer_type = Module["___cxa_is_pointer_type"] = Module["asm"]["D"]).apply(null, arguments);
        };

        Module["dynCall_jiji"] = function () {
          return (Module["dynCall_jiji"] = Module["asm"]["E"]).apply(null, arguments);
        };
    ...
    class VideoDecoderSoftSIMD extends VideoDecoderSoftBase {
      constructor() {
        super(Module$1);
      }
    ...
    class VideoDecoderHard extends eventemitter3 {
      decoderState;
    ...
    class VideoDecoder extends eventemitter3 {
      decoder;
      ...
      constructor(vdtype) {
        ...
        this.decoder.on("videoCodecInfo"
        /* VideoCodecInfo */
        , codecinfo => {
          this.emit("videoCodecInfo"
          /* VideoCodecInfo */
    ...
    var Module = (() => {
      ...
      return function (Module) {
        ...
        if (Module["locateFile"]) {
          ...
          wasmBinaryFile = new URL("audiodec.wasm", (typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('avplayer.js', document.baseURI).href))).toString();
        }
        ...
        Module["_ff_h264_cabac_tables"] = 144901;
    ...
    class AudioDecoderSoft extends eventemitter3 {
      decoderState;
      decoder;
      config;
      module;
    ...
    class AudioDecoder extends eventemitter3 {
      decoder;
      ...
      constructor(adtype) {
        ...
        this.decoder.on("audioCodecInfo"
        /* AudioCodecInfo */
        , codecinfo => {
          this.emit("audioCodecInfo"
          /* AudioCodecInfo */
    ...
    class StreamCore extends eventemitter3 {
      ...
      async tryDecode() {
        ...
        if (dpacket.dptype == DecodePacketType.VideoInfo) {
          ...
          let config = {
            videoType: dpacket.vtype,
            extraData: dpacket.extradata
          };
